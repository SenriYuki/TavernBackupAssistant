...
o	A: Did you restart SillyTavern? Did you set enableServerPlugins: true in config.yaml?
o	(你重启酒馆了吗？你在 config.yaml 里开启服务端插件权限了吗？)
•	Q: Upload failed / Network Error? (上传失败/网络错误？)
o	A: You likely forgot to set disableCsrfProtection: true.
o	(你大概率忘记将 disableCsrfProtection 设为 true 了。)
